								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-left-padding">
									<div class="form-group">
										...
										<div class="input-append date form_datetime" id="from-date">
											<input type="text" readonly class="custom-datepicker-input required" value="<?=date("d/m/Y",strtotime($task_detail->start_date))?>" name="start_date" placeholder="From Date...">
											<span class="add-on">
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-right-padding">
									<div class="form-group">
										...
										<div class="input-append date form_datetime" id="to-date">
											<input type="text" readonly class="custom-datepicker-input required" value="<?=date("d/m/Y",strtotime($task_detail->end_date))?>" name="end_date" placeholder="To Date...">
											<span class="add-on">
												<i class="fa fa-calendar date-icons custom_datepicker_icons" aria-hidden="true"></i>
											</span>
										</div>
